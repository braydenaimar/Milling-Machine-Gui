...
define([ 'jquery' ], function ($) {
	...
	/**
	*  Polyfill for the str.padStart(targetLength [, padString]) method.
	*  @param {Number} targetLength The length of the final string.
	*  @param {String} padString    The string to use for padding, default value is " " (space).
	*/
	...
	/**
	 *  Polyfill for the str.padEnd(targetLength [, padString]) method.
	 *  @param {Number} targetLength The length of the final string.
	 *  @param {String} padString    The string to use for padding, default value is " " (space).
	 */
	// https://github.com/uxitten/polyfill/blob/master/string.polyfill.js
	...
	this.gui = {
		 ...
		 *  @param {Object} sources The donor object.
		 */
		mergeDeep(target, ...sources) {

			if (!sources.length)  // If there are no sources arguments
				return target;
